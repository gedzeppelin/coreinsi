<template>
  <div class="container footer-container">
    <span class="title">CEIS UNSCH <span class="year">@2019</span></span>
    ...
    <div class="nr-contact-helper">
      <div class="nr-item-helper-left">
        ...
        <br />
        <a href="mailto: epis.unsch@gmail.com">
          <font-awesome-icon :icon="['far', 'envelope']" class="envelope" />
        </a>
        <br />
        <span class="mail">epis.unsch@gmail.com</span>
      </div>
      ...
      <div class="nr-item-helper-right">
        ...
        <div class="social-cont">
          <!-- <a href="https://www.facebook.com/groups/1425237611081130/" target="_blank">
    ...
    <span class="nr-by-powered">
      @<a href="https://gedzeppelin.xyz" target="_blank">thefungusrocket</a> - powered by:
      <a href="https://gedzeppelin.xyz" target="_blank">enigma.sass</a>
    </span>

    <span class="by">@<a href="https://gedzeppelin.xyz" target="_blank">thefungusrocket</a></span>
    <span class="powered">powered by: <a href="https://gedzeppelin.xyz" target="_blank">enigma.scss</a></span>
  </div>
</template>
