const messages = {
	es:{
		...
		about_text: "Proin viverra elit ipsum, id maximus ante porttitor vel. Etiam efficitur arcu libero. Proin blandit lacinia ante vel euismod. Ut nec semper velit, quis semper ante. In rutrum vel velit ut iaculis. Duis varius tellus metus, non iaculis odio rhoncus a. Vivamus semper lectus sapien, finibus elementum massa semper sed. Etiam eu congue velit. Sed tempus est id nisl cursus malesuada.",
